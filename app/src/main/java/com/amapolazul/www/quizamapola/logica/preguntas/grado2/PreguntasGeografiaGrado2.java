...
import com.amapolazul.www.quizamapola.logica.preguntas.grado1.ResultadosQuizGrado1;
...
public class PreguntasGeografiaGrado2 extends Activity {

    private QuizDAO quizDao;
    private int indicePrguntaActual;
    private Pregunta preguntaActual;
    private List<Pregunta> preguntasGeografiaGradoDos;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas_geografia_grado2);

        indicePrguntaActual = 0;
        contador = Contador.getInstance();
        contadorCorrectas = (TextView) findViewById(R.id.contadorCorrectasGeografiaG2);
        contadorIncorrectas = (TextView) findViewById(R.id.contadorIncorrectasGeografiaG2);
        ...
        TextView enunciado = (TextView) findViewById(R.id.enunciadoGeografiaG2);
        enunciado.setMovementMethod(new ScrollingMovementMethod());
        try {
            quizDao = new QuizDAO(this);
            quizDao.open();
            preguntasGeografiaGradoDos = quizDao.darPreguntas(CategoriasEnum.GEOGRAFIA.getValor(), "2");
            inicializarQuiz();
    ...
    private void inicializarQuiz(){
        preguntaActual = preguntasGeografiaGradoDos.get(indicePrguntaActual);
        TextView enunciado = (TextView) findViewById(R.id.enunciadoGeografiaG2);
        TextView respuestaA = (TextView) findViewById(R.id.respuestaAGeografiaG2);
        TextView respuestaB = (TextView) findViewById(R.id.respuestaBGeografiaG2);
        TextView respuestaC = (TextView) findViewById(R.id.respuestaCGeografiaG2);
        TextView respuestaD = (TextView) findViewById(R.id.respuestaDGeografiaG2);
    ...
    private synchronized void reiniciarRespuestasYAvanzar() throws InterruptedException {
        ...
        if(indicePrguntaActual < preguntasGeografiaGradoDos.size()){
            inicializarQuiz();
        } else {
            Intent intent = new Intent(this, ResultadosQuizGrado2.class);
            startActivity(intent);
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_preguntas_geografia_grado2, menu);
        return true;
    }
