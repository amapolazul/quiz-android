...
public class PreguntasMatematicasGrado4 extends Activity {

    private QuizDAO quizDao;
    private int indicePrguntaActual;
    private Pregunta preguntaActual;
    private List<Pregunta> preguntasMatematicasGradoCuatro;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas_matematicas_grado4);
        ...
        contadorIncorrectas = (TextView) findViewById(R.id.contadorIncorrectasMatematicasG4);
        ...
        try {
            ...
            quizDao.open();
            preguntasMatematicasGradoCuatro = quizDao.darPreguntas(CategoriasEnum.MATEMATICAS.getValor(), "4");
            inicializarQuiz();
    ...
    private void inicializarQuiz() {
        preguntaActual = preguntasMatematicasGradoCuatro.get(indicePrguntaActual);
        TextView enunciado = (TextView) findViewById(R.id.enunciadoMatematicasG4);
    ...
    private synchronized void reiniciarRespuestasYAvanzar() throws InterruptedException {
        ...
        if (indicePrguntaActual < preguntasMatematicasGradoCuatro.size()) {
            inicializarQuiz();
        } else {
            handler = new Handler();
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    Intent intent = new Intent(PreguntasMatematicasGrado4.this, LenguajeIntroduccionGrado4.class);
                    startActivity(intent);
                }
            }, 500);
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_preguntas_matematicas_grado4, menu);
        return true;
    }
