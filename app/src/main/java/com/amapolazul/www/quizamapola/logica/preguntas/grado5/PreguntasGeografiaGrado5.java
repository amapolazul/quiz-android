...
import com.amapolazul.www.quizamapola.logica.preguntas.grado4.ResultadosQuizGrado4;
...
public class PreguntasGeografiaGrado5 extends Activity {

    private QuizDAO quizDao;
    private int indicePrguntaActual;
    private Pregunta preguntaActual;
    private List<Pregunta> preguntasGeografiaGradoCinco;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas_geografia_grado5);

        indicePrguntaActual = 0;
        contador = Contador.getInstance();
        contadorCorrectas = (TextView) findViewById(R.id.contadorCorrectasGeografiaG5);
        contadorIncorrectas = (TextView) findViewById(R.id.contadorIncorrectasGeografiaG5);
        ...
        TextView enunciado = (TextView) findViewById(R.id.enunciadoGeografiaG5);
        enunciado.setMovementMethod(new ScrollingMovementMethod());
        try {
            quizDao = new QuizDAO(this);
            quizDao.open();
            preguntasGeografiaGradoCinco = quizDao.darPreguntas(CategoriasEnum.GEOGRAFIA.getValor(), "5");
            inicializarQuiz();
    ...
    private void inicializarQuiz(){
        preguntaActual = preguntasGeografiaGradoCinco.get(indicePrguntaActual);
        TextView enunciado = (TextView) findViewById(R.id.enunciadoGeografiaG5);
        TextView respuestaA = (TextView) findViewById(R.id.respuestaAGeografiaG5);
        TextView respuestaB = (TextView) findViewById(R.id.respuestaBGeografiaG5);
        TextView respuestaC = (TextView) findViewById(R.id.respuestaCGeografiaG5);
        TextView respuestaD = (TextView) findViewById(R.id.respuestaDGeografiaG5);
    ...
    private synchronized void reiniciarRespuestasYAvanzar() throws InterruptedException {
        ...
        if(indicePrguntaActual < preguntasGeografiaGradoCinco.size()){
            inicializarQuiz();
        } else {
            Intent intent = new Intent(this, ResultadosQuizGrado5.class);
            startActivity(intent);
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_preguntas_geografia_grado5, menu);
        return true;
    }
