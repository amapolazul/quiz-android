...
import com.amapolazul.www.quizamapola.logica.preguntas.grado3.ResultadosQuizGrado3;
...
public class PreguntasGeografiaGrado4 extends Activity {

    private QuizDAO quizDao;
    private int indicePrguntaActual;
    private Pregunta preguntaActual;
    private List<Pregunta> preguntasGeografiaGradoCuatro;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas_geografia_grado4);

        indicePrguntaActual = 0;
        contador = Contador.getInstance();
        contadorCorrectas = (TextView) findViewById(R.id.contadorCorrectasGeografiaG4);
        contadorIncorrectas = (TextView) findViewById(R.id.contadorIncorrectasGeografiaG4);
        ...
        TextView enunciado = (TextView) findViewById(R.id.enunciadoGeografiaG4);
        enunciado.setMovementMethod(new ScrollingMovementMethod());
        try {
            quizDao = new QuizDAO(this);
            quizDao.open();
            preguntasGeografiaGradoCuatro = quizDao.darPreguntas(CategoriasEnum.GEOGRAFIA.getValor(), "4");
            inicializarQuiz();
    ...
    private void inicializarQuiz(){
        preguntaActual = preguntasGeografiaGradoCuatro.get(indicePrguntaActual);
        TextView enunciado = (TextView) findViewById(R.id.enunciadoGeografiaG4);
        TextView respuestaA = (TextView) findViewById(R.id.respuestaAGeografiaG4);
        TextView respuestaB = (TextView) findViewById(R.id.respuestaBGeografiaG4);
        TextView respuestaC = (TextView) findViewById(R.id.respuestaCGeografiaG4);
    ...
    private synchronized void reiniciarRespuestasYAvanzar() throws InterruptedException {
        ...
        if(indicePrguntaActual < preguntasGeografiaGradoCuatro.size()){
            inicializarQuiz();
        } else {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_preguntas_geografia_grado4, menu);
        return true;
    }
