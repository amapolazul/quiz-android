...
public class PreguntasCienciasGrado2 extends Activity {

    private QuizDAO quizDao;
    private int indicePrguntaActual;
    private Pregunta preguntaActual;
    private List<Pregunta> preguntasCienciasGradoDos;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas_ciencias_grado2);

        indicePrguntaActual = 0;
        contador = Contador.getInstance();
        contadorCorrectas = (TextView) findViewById(R.id.contadorCorrectasCienciasG2);
        contadorIncorrectas = (TextView) findViewById(R.id.contadorIncorrectasCienciasG2);
        ...
        TextView enunciado = (TextView) findViewById(R.id.enunciadoCienciasG2);
        ...
        try {
            ...
            quizDao.open();
            preguntasCienciasGradoDos = quizDao.darPreguntas(CategoriasEnum.CIENCIAS.getValor(), "2");
            inicializarQuiz();
    ...
    private void inicializarQuiz(){
        preguntaActual = preguntasCienciasGradoDos.get(indicePrguntaActual);
        TextView enunciado = (TextView) findViewById(R.id.enunciadoCienciasG2);
        TextView respuestaA = (TextView) findViewById(R.id.respuestaACienciasG2);
        TextView respuestaB = (TextView) findViewById(R.id.respuestaBCienciasG2);
        TextView respuestaC = (TextView) findViewById(R.id.respuestaCCienciasG2);
        TextView respuestaD = (TextView) findViewById(R.id.respuestaDCienciasG2);
    ...
    private synchronized void reiniciarRespuestasYAvanzar() throws InterruptedException {
        ...
        if(indicePrguntaActual < preguntasCienciasGradoDos.size()){
            inicializarQuiz();
        } else {
            handler = new Handler();
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    Intent intent = new Intent(PreguntasCienciasGrado2.this, PreguntasGeografiaGrado2.class);
                    startActivity(intent);
                }
            }, 500);
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_preguntas_ciencias_grado2, menu);
        return true;
    }
