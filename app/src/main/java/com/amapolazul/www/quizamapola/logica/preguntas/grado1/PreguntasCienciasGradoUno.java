...
public class PreguntasCienciasGradoUno extends Activity {

    private QuizDAO quizDao;
    private int indicePrguntaActual;
    private Pregunta preguntaActual;
    private List<Pregunta> preguntasCienciasGradoUno;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas_ciencias_grado_uno);
        ...
        contadorIncorrectas = (TextView) findViewById(R.id.contadorIncorrectasCiencias);
        ...
        TextView enunciado = (TextView) findViewById(R.id.enunciadoPregunta);
        enunciado.setMovementMethod(new ScrollingMovementMethod());

        try {
            quizDao = new QuizDAO(this);
            quizDao.open();
            preguntasCienciasGradoUno = quizDao.darPreguntas(CategoriasEnum.CIENCIAS.getValor(), "1");
            inicializarQuiz();
    ...
    private void inicializarQuiz(){
        preguntaActual = preguntasCienciasGradoUno.get(indicePrguntaActual);
        TextView enunciado = (TextView) findViewById(R.id.enunciadoPregunta);
        TextView respuestaA = (TextView) findViewById(R.id.respuestaATexto);
        TextView respuestaB = (TextView) findViewById(R.id.respuestaBTexto);
        TextView respuestaC = (TextView) findViewById(R.id.respuestaCText);
    ...
    private synchronized void reiniciarRespuestasYAvanzar() throws InterruptedException {
        ...
        if(indicePrguntaActual < preguntasCienciasGradoUno.size()){
            inicializarQuiz();
        } else {
            handler = new Handler();
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    Intent intent = new Intent(PreguntasCienciasGradoUno.this, PreguntasGeografiaGradoUno.class);
                    startActivity(intent);
                }
            }, 500);
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_preguntas_ciencias_grado_uno, menu);
        return true;
    }
