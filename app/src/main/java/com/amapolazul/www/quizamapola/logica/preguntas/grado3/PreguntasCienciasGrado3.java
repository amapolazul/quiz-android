...
public class PreguntasCienciasGrado3 extends Activity {

    private QuizDAO quizDao;
    private int indicePrguntaActual;
    private Pregunta preguntaActual;
    private List<Pregunta> preguntasCienciasGradoTres;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas_ciencias_grado3);

        indicePrguntaActual = 0;
        contador = Contador.getInstance();
        contadorCorrectas = (TextView) findViewById(R.id.contadorCorrectasCienciasG3);
        contadorIncorrectas = (TextView) findViewById(R.id.contadorIncorrectasCienciasG3);
        ...
        TextView enunciado = (TextView) findViewById(R.id.enunciadoCienciasG3);
        ...
        try {
            ...
            quizDao.open();
            preguntasCienciasGradoTres = quizDao.darPreguntas(CategoriasEnum.CIENCIAS.getValor(), "3");
            inicializarQuiz();
    ...
    private void inicializarQuiz(){
        preguntaActual = preguntasCienciasGradoTres.get(indicePrguntaActual);
        TextView enunciado = (TextView) findViewById(R.id.enunciadoCienciasG3);
        TextView respuestaA = (TextView) findViewById(R.id.respuestaACienciasG3);
        TextView respuestaB = (TextView) findViewById(R.id.respuestaBCienciasG3);
        TextView respuestaC = (TextView) findViewById(R.id.respuestaCCienciasG3);
    ...
    private synchronized void reiniciarRespuestasYAvanzar() throws InterruptedException {
        ...
        if(indicePrguntaActual < preguntasCienciasGradoTres.size()){
            inicializarQuiz();
        } else {
            handler = new Handler();
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    Intent intent = new Intent(PreguntasCienciasGrado3.this, PreguntasGeografiaGrado3.class);
                    startActivity(intent);
                }
            }, 500);
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_preguntas_ciencias_grado3, menu);
        return true;
    }
