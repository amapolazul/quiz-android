...
public class PreguntasLenguajeGrado3 extends Activity {
    ...
    private void inicializarQuiz(){
        preguntaActual = preguntasLenguajeGradoTres.get(indicePrguntaActual);
        TextView enunciado = (TextView) findViewById(R.id.enunciadoLenguajeG3);
        TextView respuestaA = (TextView) findViewById(R.id.respuestaALenguajeG3);
        TextView respuestaB = (TextView) findViewById(R.id.respuestaBLenguajeG3);
        ...
        if(indicePrguntaActual < preguntasLenguajeGradoTres.size()){
            ...
            if(proximaLectura.equals(lecturaPregunta)){
                ...
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent intent = new Intent(PreguntasLenguajeGrado3.this, LenguajeIntroduccionGradoTres.class);
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    Intent intent = new Intent(PreguntasLenguajeGrado3.this, PreguntasCienciasGrado3.class);
                    startActivity(intent);
                }
            }, 500);
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_preguntas_lenguaje_grado3, menu);
        return true;
    }
